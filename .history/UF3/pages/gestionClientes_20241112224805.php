...
session_start();
if ($usuario == 'admin') {
    header("Location: gestionClientes.php"); // Redirige al panel de administración si es admin
} else {
    header("Location: ../index.php"); // Redirige al inicio si es un usuario normal
}
