...
if (isset($_POST['confirmado'])) {
    try {
        ...
        $consulta = "INSERT INTO usuarios (nombre, edad, nick, password) VALUES ('$nombre', $edad, '$nick', '$password')";
...
if ($fila['total'] > 0) {
    ...
    $consulta = "INSERT INTO usuarios (nombre, edad, nick_usuario, password) VALUES ('$nombre', $edad, '$nick', '$password')";
