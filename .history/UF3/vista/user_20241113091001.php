...
<div>
    ...
    foreach ($libros->libro as $libro) {
        ...
        $isbn = $libro->isbn; // Asegúrate de que en biblioteca.xml exista el campo ISBN
        ...
        echo "<a href='formularioPedido.php?titulo=" . urlencode($titulo) . "&isbn=" . urlencode($isbn) . "'>Comprar</a>";
